...
export const navigationConfig: NavItem[] = [
    {
            ...
            columns: [
                {
                    ...
                    items: [
                        { labelKey: 'nav_home_rss', href: '/rss.xml', descKey: 'nav_home_rss_desc', icon: IconRss },
                        { labelKey: 'nav_home_github', href: 'https://github.com/guangyiliushan', descKey: 'nav_home_github_desc', icon: IconBrandGithub },
                        { labelKey: 'nav_home_twitter', href: 'https://twitter.com/guangyiliushan', descKey: 'nav_home_twitter_desc', icon: IconBrandTwitter },
                        { labelKey: 'nav_home_email', href: 'mailto:guangyiliushan@example.com', descKey: 'nav_home_email_desc', icon: IconMail }
                    ]
                }
            ]
        },
        children: [
            ...
            { labelKey: 'nav_home_github', href: 'https://github.com/guangyiliushan', icon: IconBrandGithub },
            { labelKey: 'nav_home_twitter', href: 'https://twitter.com/guangyiliushan', icon: IconBrandTwitter },
    ...
    },
    {
        ...
        children: [
            { labelKey: 'nav_posts_view_all', href: '/posts' }
        ]
    },
    {
        key: 'nav_notes',
    ...
    },
    {
        ...
        children: [
            { labelKey: 'nav_timeline_view_all', href: '/timeline' }
        ]
    },
    {
        key: 'nav_thinking',
    ...
    },
    {
        ...
        megaMenu: {
            ...
            columns: [
                {
                    items: [
                        { labelKey: 'nav_more_friends', href: '/friends', descKey: 'nav_more_friends_desc', icon: IconUsers },
                        { labelKey: 'nav_more_projects', href: '/projects', descKey: 'nav_more_projects_desc', icon: IconFlask },
                        { labelKey: 'nav_more_quotes', href: '/says', descKey: 'nav_more_quotes_desc', icon: IconQuote },
                        { labelKey: 'nav_more_warp', href: 'https://travel.moe/go.html', descKey: 'nav_more_warp_desc', icon: IconWorld }
                    ]
                }
            ]
        },
